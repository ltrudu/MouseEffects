...
| **Color Blindness NG** | Next-gen CVD plugin with per-zone configuration, LUT-based correction, custom presets, Circle/Rectangle cursor-following modes, Simulation-Guided Correction, and Re-simulation mode to preview how corrections appear to colorblind users |
